        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Cities_CurrentCityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Cities_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_Cities_Cities_CityID",
                        column: x => x.CityID,
                        principalTable: "Cities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Images_AspNetUsers_ApplicationUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Animal_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Animal_Comments_Animals_AnimalID",
                        column: x => x.AnimalID,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Animal_Comments_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animal_Images_Animals_AnimalID",
                        column: x => x.AnimalID,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Animal_Comments_AnimalID",
                table: "Animal_Comments",
                column: "AnimalID");

            migrationBuilder.CreateIndex(
                name: "IX_Animal_Comments_UserID",
                table: "Animal_Comments",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_Animal_Images_AnimalID",
                table: "Animal_Images",
                column: "AnimalID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Cities_CityID",
                table: "User_Cities",
                column: "CityID");

            migrationBuilder.CreateIndex(
                name: "IX_User_Cities_UserID",
                table: "User_Cities",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_User_Images_ApplicationUserID",
                table: "User_Images",
