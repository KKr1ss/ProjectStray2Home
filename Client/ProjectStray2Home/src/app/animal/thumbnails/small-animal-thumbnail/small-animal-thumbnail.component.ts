...
@Component({
  selector: 'app-small-animal-thumbnail',
  templateUrl: './small-animal-thumbnail.component.html',
  styleUrls: ['./small-animal-thumbnail.component.scss']
})
export class SmallAnimalThumbnailComponent implements OnInit {
